...
export default {
  content: [], // This will be overridden by consuming packages
  theme: {
    container: {
      center: true,
      padding: '2rem',
    ...
    extend: {
      colors: {
        ...
        'notes-bg': 'hsl(var(--notes-bg))',
        timestamp: 'hsl(var(--timestamp))',
        'timestamp-active': 'hsl(var(--timestamp-active))',
      ...
      // Base theme extensions that all packages can use
      fontFamily: {
        sans: [
          'Inter',
          'ui-sans-serif',
